...
const exerciseCategoryModelSchema = createSelectSchema(exerciseCategoryTable)
const exerciseCategoryDtoSchema = exerciseCategoryModelSchema
const exerciseCategoryInputSchema = createInsertSchema(exerciseCategoryTable)
const exerciseCategoryUpdateSchema = exerciseCategoryInputSchema
  .partial()
  .required({ category_id: true })

export type ExerciseCategoryModel = z.infer<typeof exerciseCategoryModelSchema>
export type ExerciseCategoryDto = z.infer<typeof exerciseCategoryDtoSchema>
export type ExerciseCategoryInput = z.infer<typeof exerciseCategoryInputSchema>
